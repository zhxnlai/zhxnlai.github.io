      ...
      <div className="murmur-page full-page-section pure-g">
        ...
        <div className="murmur-open-source pure-u-1 full-width-section ">
          <div className="full-width-section-content ">
            ...
            <div className="l-box pure-u-1 ">
              <p>We opensourced some of our components and people loved it. <a href="https://github.com/zhxnlai/ZLSwipeableView">ZLSwipeableView</a> became a monthly trending project on github.</p>
            </div>
          </div>
        </div>
